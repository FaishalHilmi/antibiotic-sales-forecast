      ...
      <div className="bg-white border border-gray-200 rounded-2xl p-4 md:p-7">
        <div className="header flex flex-col md:flex-row justify-between md:items-center mb-7">
          <div className="link-back mb-3 md:mb-0">
            <Link href={"/"} className="flex gap-2 text-sm md:text-base">
              {" "}
              <MoveLeft className="w-5 text-black" />{" "}
              <span className="text-black">Riwayat Transaksi</span>
            </Link>
          </div>
          <div className="mobile-section flex flex-col justify-between gap-2 md:hidden">
            ...
            <div className="button-action flex gap-2">
              ...
              <button className="text-xs md:text-md bg-yellow-500 flex items-center gap-2 px-3 py-2 rounded-lg">
                <SquarePen className="w-4 text-white" />
                <span className="text-white">Edit Transaksi</span>
              </button>
            </div>
          </div>
          ...
          <div className="button-action gap-2 hidden md:flex">
            ...
            <button className="text-sm md:text-md bg-yellow-500 flex items-center gap-2 px-3 py-2 rounded-lg">
              <SquarePen className="w-4 text-white" />
              <span className="text-white">Edit Transaksi</span>
            </button>
          </div>
